...
define :wordpress_deployment_localisation do
  ...
  def update_wpcontent(sharedPath)
  ...
  def overwrite_wpcontent(sharedPath)
  ...
  def deploy_cms_framework(sharedPath)
  ...
  deploy_cms_framework(sharedPath)
end
